...
//         CICDEEZ<span className='blink'>_</span>
//       </h1>
//       <p>A GitHub Actions visualizer.</p>
  ...
  return (
    <div className='Home'>
      ...
      <section className='Home-content'>
        <h2>A GitHub Actions visualization tool.</h2>
        <h3>Gain actionable insights on your workflow metrics.</h3>
        <a href='https://github.com/login/oauth/authorize?client_id=Iv1.cdabdacb14c5030c'>
          <button type='button' className='gh-login-button'>
            <svg
              xmlns='http://www.w3.org/2000/svg'
